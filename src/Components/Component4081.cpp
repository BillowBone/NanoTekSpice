...
namespace nts {
    Component4081::Component4081(const std::string &name) : ComponentContainer(name, "4081")
    {
    ...
    Tristate Component4081::compute(size_t pin)
    {
        ...
        this->getLink(in1);
        this->getLink(in2);
        out->setState(LogicGates::andGate(in1->getState(), in2->getState()));
        in1 = this->getPin(5);
        in2 = this->getPin(6);
        this->getLink(in1);
        this->getLink(in2);
