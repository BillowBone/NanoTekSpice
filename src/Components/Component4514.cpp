...
namespace nts {
    Component4514::Component4514(const std::string &name) : ComponentContainer(name, "4514")
    {
        ComponentPin *pin1 = new ComponentPin(this, pinType::OTHER, Tristate::UNDEFINED, 1);
        ...
        ComponentPin *pin18 = new ComponentPin(this, pinType::OUTPUT, Tristate::UNDEFINED, 18);
        ComponentPin *pin19 = new ComponentPin(this, pinType::OUTPUT, Tristate::UNDEFINED, 19);
        ComponentPin *pin20 = new ComponentPin(this, pinType::OUTPUT, Tristate::UNDEFINED, 20);
        ComponentPin *pin21 = new ComponentPin(this, pinType::INPUT, Tristate::UNDEFINED, 21);
        ComponentPin *pin22 = new ComponentPin(this, pinType::INPUT, Tristate::UNDEFINED, 22);
        ComponentPin *pin23 = new ComponentPin(this, pinType::OTHER, Tristate::UNDEFINED, 23);
