...
namespace nts {
    Component2716::Component2716(const std::string &name) : ComponentContainer(name, "2716")
    {
        ...
        ComponentPin *pin19 = new ComponentPin(this, pinType::INPUT, Tristate::UNDEFINED, 19);
