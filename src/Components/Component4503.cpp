...
namespace nts {
    Component4503::Component4503(const std::string &name) : ComponentContainer(name, "4503")
    {
        ...
        ComponentPin *pin10 = new ComponentPin(this, pinType::INPUT, Tristate::UNDEFINED, 10);
        ...
        ComponentPin *pin14 = new ComponentPin(this, pinType::INPUT, Tristate::UNDEFINED, 14);
        ComponentPin *pin15 = new ComponentPin(this, pinType::INPUT, Tristate::UNDEFINED, 15);
